...
$lsgkm_dir/gkmtrain -t 2 -m 60000 -v 2 -T 16 $indir/$task/svm.inputs.$task.train.$fold.positives $indir/$task/svm.inputs.$task.train.$fold.negatives $outdir/$task/models/$task.$fold
